  ...
  # For each of those bibs, store the YEAR (or 9999 if missing) and AUTHOR (or editor if no author; error if neither)
      ...
      for (bib in 1:bibTotal) {
        ...
        if (identical(thisYear, character(0))) {
          thisYear = "9999"
          message(paste0("Year not found for bib ", bib, ", using 9999 instead"))
          }
      ...
      for (bib in 1:bibTotal) {
          ...
          if (identical(thisAuthor, character(0))) {
            ...
            if (!identical(thisAuthor, character(0))) message(paste0("Author not found for bib ", bib, ", using editor instead"))
            ...
            if (!identical(thisAuthor, character(0))) message(paste0("Author not found for bib ", bib, ", using title instead (is this an Act? If not, there should be an author or editor)"))
          }
  ...
  # Retrieve title for sorting and key generation
      for (bib in 1:bibTotal) {
        ...
        if (identical(thisTitle, character(0))) {
          thisTitle <- ""
          message(paste0("Title not found for bib ", bib, "!"))
        }
